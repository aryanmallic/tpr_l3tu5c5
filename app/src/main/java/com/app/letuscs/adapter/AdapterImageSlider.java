...
import com.app.letuscs.models.postsModel.ModelPostsImage;
import com.bumptech.glide.Glide;

import java.util.List;

public class AdapterImageSlider extends PagerAdapter implements View.OnClickListener{
    private Context mContext;
    private List<ModelPostsImage> modelPostsImages;
    private LayoutInflater layoutInflater;
    private View view;


    public AdapterImageSlider(Context mContext, List<ModelPostsImage> modelPostsImages) {
